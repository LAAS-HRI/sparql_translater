...
def main(templates_file_path="templates_classif.txt", individuals_file_path="individuals.csv", max_examples_per_template=600, train_file="train.txt", val_file="val.txt"):
